...
int main(int argc, char* argv[])
{
  ...
  try {
	...
	cin >> input;
	if (input == "option") {
		cout << "Please input the test file Path\n";
		cin >> input;
		argv[1] = &input[0];
		cout << "choose the option for the file pattern:\n 1. Only .h file\n 2. Only  .cpp file\n 3. Both file\n";
		cin >> option;
	...
	std::cout << "\n  --Req#9&10 Show the Demo Below--\n";
	cout << "\n Current Analysis directory" << argv[1];
...
void printReq1to8() {
	std::cout << "\n  --Req#1 The Project uses the Visual Studio 2015 and its C++ Windows Console--\n";
	std::cout << "\n  --Req#2 The Project uses C++ standard library--\n";
	std::cout << "\n  --Req#3 The creation of Web page are stored in the Result Folder--\n";
	std::cout << "\n  --Req#4 In the web page file, use the + button to see the expansion--\n";
	std::cout << "\n  --Req#5 The .css style sheet is in the Result Folder\n";
	std::cout << "\n  --Req#6&7 see the Web page file in the Result folder--\n";
	std::cout << "\n  --Req#8--\n";
	cout << "input word \"option\" to run the Program for specified Path and Pattern\n";
	cout << "Or input any other word to Run the default test\n";
}
