...
int main(int argc, char* argv[])
{
  ...
  try {
	...
	std::cout << "\n  --Req#3 The operation of each task will demo below--\n";
	std::cout << "\n  --Req#3 The TestExec in this project called Executive which is under codeAnalyzer project--\n";
	std::cout << "\n  --Req#3 Use the GUI to choose which folder you want to test--\n";
